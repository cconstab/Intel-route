...
Dart interoperate (verified in `validation/`).
...
validation/                   SDK + Python<->Dart interop proof (the de-risking spike)
```
...
pip install "atsdk>=0.2.71" pydantic langgraph==1.0.9 gpxpy folium "gradio>=6.7.0"
